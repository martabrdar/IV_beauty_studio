...
const HomeScreen = () => {
  // Prikaži samo prvih 4 na home stranici
    ...
    <>
      ...
      <div className="hero">
        <Container>
          ...
          <div className="d-flex gap-3 justify-content-center flex-wrap">
            <Link to="/services">
              <button className="btn-gold">Pogledaj usluge</button>
            </Link>
            <Link to="/booking">
              <button className="btn-outline-gold">Zakaži termin</button>
            </Link>
          </div>
        </Container>
      </div>
      ...
      <Container className="py-5">
        ...
        <div className="text-center mt-2">
          <Link to="/services">
            <button className="btn-outline-gold">Sve usluge →</button>
          </Link>
        </div>
      </Container>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-around', textAlign: 'center' }}>
            {[
              ...
              <div key={i}>
                ...
                <div style={{ fontSize: '0.7rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--gray)', marginTop: '0.5rem' }}>
                  {item.tekst}
                </div>
              </div>
            ))}
